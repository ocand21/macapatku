        ...
        <form method="POST" action="{{route('admin.password.request')}}" aria-label="{{ __('Reset Password')}}">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="email" id="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}" readonly placeholder="Email address" required="required">
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <label for="password_confirm">{{ __('Konfirmasi Password') }}</label>
