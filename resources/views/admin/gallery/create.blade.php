...
@section('css')
  ...
  <link rel="stylesheet" href="/admin/dropzone/custom.css">
@endsection
...
<!-- Breadcrumbs-->
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <h2 class="page-heading">Upload foto ke galeri <span id="counter"></span></h2>
      <form method="post" action="{{ route('gallery.store') }}"
                ...
                <div class="dz-message">
                    <div class="col-xs-8">
                        <div class="message">
                            <p>Tarik foto atau klik di sini</p>
                        </div>
                    </div>
                </div>
                <div class="fallback">
...
@section('js')
  <script type="text/javascript" src="/admin/dropzone/dropzone.js"></script>
    <script type="text/javascript" src="/admin/dropzone/dropzone-config.js"></script>
@endsection
